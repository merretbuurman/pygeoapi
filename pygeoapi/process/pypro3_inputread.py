...
'''
curl -X POST "http://130.225.37.27:5000/processes/assessment-indicator-b/execution" -H "Content-Type: application/json" -d "{\"inputs\":{\"assessmentPeriod\": \"2011-2016\"}}"
...
PROCESS_METADATA = {
    ...
    'outputs': {
        'verbal_result': {
            ...
            'description': 'Assessment CSV, ask HELCOM.',
            'schema': {
                'type': 'object',
